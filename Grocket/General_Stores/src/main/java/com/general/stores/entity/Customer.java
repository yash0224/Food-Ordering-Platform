...
public class Customer {
	...
	@Column(name = "wallet_money", nullable = false, columnDefinition = "int default 0")
	...
	public void setWallet(Integer money) {
	...
	public String toString() {
		return "Customer [id=" + id + ", name=" + name + ", password=" + password + ", email=" + email + ", gender="
				...
				+ ", createDate=" + createDate +", wallet_money=" + wallet_money + "]";
	} 

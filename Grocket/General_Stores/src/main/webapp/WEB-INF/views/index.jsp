<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		...
		<body>
			...
			<img src="images/b1.png" alt="Description of the image" width="1520" height="600">
							...
							<div class="wrapper">
								...
								<div class="px-sm-4 px-3 py-sm-5 py-3 mb-4">
									<c:if test="${not empty products}">
										<h3 class="heading-tittle text-center font-italic">Welcome</h3>
									</c:if>
									<div class="row">
										<c:choose>
								...
								<div class="col-12 text-center">
									<button><a class="nav-link"
											href="${pageContext.request.contextPath}/product/all">View All
											Products</a></button>
								</div>
							</div>
						</div>

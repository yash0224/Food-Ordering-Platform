...
-- first create a database with below command
...
INSERT INTO `admin` (`id`, `added_date`, `email`, `password`, `name`) VALUES
    (1, '2020-05-16 00:46:08', 'yaswanth@gmail.com', '123456', 'yaswanth');
...
INSERT INTO `contact` (`id`, `contact_date`, `email`, `message`, `name`, `subject`) VALUES
    (2, '2020-07-25 19:45:20', 'aditya@gmail.com', 'Hi, This is testing email contacts.', 'aditya', 'Testing');
...
CREATE TABLE `customer` (
                            ...
                            `wallet_money` varchar(10) NOT NULL,
...
INSERT INTO `customer` (`id`, `address`, `added_date`, `email`, `gender`, `name`, `password`, `phone`, `valid`, `wallet_money`,`pin_code`) VALUES
    (1, 'hyderabad', '2020-05-10 11:11:01', 'aditya@gmail.com', 'Male', 'aditya', '$2a$10$QQeMRbMjnXys3cDIvvozH.dpxxCLD9d0b5Pz092djiwkSLW1YJ/Vy', '1223334560', '1','1', '400330');
...
INSERT INTO `orders` (`id`, `active`, `amount`, `customer_address`, `customer_address_type`, `customer_email`, `customer_name`, `customer_phone`, `order_date`, `order_num`, `pin_code`) VALUES
                                                                                                                                                                                             (237, b'1', 284, 'hyderabad', 'Home', 'aditya@gmail.com', 'adiya', '1223334560', '2020-07-25 19:59:26', 1000, '400330'),
                                                                                                                                                                                             (238, b'1', 95, 'hyderabad', 'Home', 'aditya@gmail.com', 'aditya', '1223334560', '2020-07-25 19:59:26', 1001, '400330'),
                                                                                                                                                                                             (239, b'1', 65, 'hyderabad', 'Home', 'aditya@gmail.com', 'aditya', '1223334560', '2020-07-25 19:59:26', 1002, '400330');
...
INSERT INTO `product` (`id`, `active`, `code`, `create_date`, `description`, `image`, `name`, `price`, `mrp_price`) VALUES
                                                                                                                        ...
                                                                                                                        (2, b'1', 'P02', '2020-05-15 02:59:56', 'Chicken Wings', '/resources/119.jpg', 'Chicken Wings', 160, 168),
                                                                                                                        ...
                                                                                                                        (4, b'1', 'P04', '2020-05-15 03:03:41', 'Bread', '/resources/118.jpg', 'Bread', 160, 165),
                                                                                                                        ...
                                                                                                                        (6, b'1', 'P06', '2020-05-15 03:12:16', 'Fruits', '/resources/1 (1).jpg', 'Mixed Fruits', 160, 165),
                                                                                                                        (7, b'1', 'P07', '2020-05-15 03:13:44', 'Premium Quality singdana', '/resources/images.jpg', 'Singdana(Groundnut) 500gm', 70, 75),
                                                                                                                        (8, b'1', 'P08', '2020-05-29 01:01:54', 'Rice', '/resources/0 (1).jpg', 'Rice', 70, 75),
